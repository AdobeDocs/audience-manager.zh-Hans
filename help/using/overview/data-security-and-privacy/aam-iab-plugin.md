...
适用于IAB TCF的Audience Manager插件允许您将IAB TCF同意字符串转发给激活合作伙伴，同时尊重用户的隐私选择。 有关哪些激活合作伙伴支持IAB TCF的信息，请参阅我们的 **[Partner excel表](/help/using/overview/data-security-and-privacy/assets/AAM-Partners-October2019.xlsx)**。
