---
description: 本節概述並說明與開始使用Audience Manager資料管理平台(DMP)相關的程式。 本節旨在協助業務團隊、專案經理和技術經理瞭解Audience Manager實作程式。 視您的資料收集需求而定，Audience Manager快速入門可能需要約六週至三個月的時間。
...
本節概述及說明與開始使用Audience Manager資料管理平台([!DNL DMP])。 本節旨在協助業務團隊、專案經理和技術經理瞭解Audience Manager實作程式。 視您的資料收集需求而定，Audience Manager快速入門可能需要約六週至三個月的時間。

我們的實作技術有助於建立與新客戶的顧問式合作關係。 此程式旨在：
...
Audience Manager會分階段進行設定和實作。

## 定義階段 {#define-phase}

定義階段會向您介紹我們的合作夥伴解決方案專案負責人，並開始專案管理流程。
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> 
    <ul id="ul_E8F427586F14437285ABBF93A15FCBD4"> 
     ...
     <li id="li_991D2F069B88456CB3942970F4EF0FAF">建立與傳送日期相連結的目標和里程碑 </li> 
     <li id="li_4A2CDE7F006A45BDB04585CACF5688CA">確認現場工作的計畫 </li> 
...
探索階段專用於收集需求、開展研究，並致力於更深入地瞭解您的業務需求和資料收集策略。
...
<table id="table_89E7CD7832E142519EDC1F285A5BBE79"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   <td colname="col1"> 後續追蹤通訊 </td> 
   <td colname="col2"> 定期溝通，以供後續和開發之用 </td> 
   <td colname="col3"> 業務和技術團隊 </td> 
  </tr> 
 </tbody> 
</table>
...
* 已完成 [!DNL CRM] 或data warehouse擷取計畫；
* 已定義的對象細分需求；
* 完整的資料分類法；
* 已開發的協力廠商資料整合計畫。
...
您的資料收集策略將進行端對端處理 [!DNL QA] 測試。 合作夥伴解決方案將追蹤發現的錯誤，並與我們的系統工程師協調問題解決方案。 客戶培訓可以與其他工作同時開始。
...
| 使用者培訓 | 提供有關Audience Manager功能、工具和報告的教育及瞭解 | 業務團隊 |
...
在啟動、支援和最佳化階段中，您的資料收集和原型實作會從開發環境移至即時生產環境。 我們將持續進行產品熟悉度訓練，以及有助於提升您的產品品質 [!DNL ROI] 透過資料導向最佳化。
...
<table id="table_040B9CBED6F04A41B4501DA4B45F5A16"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2">建立真實的特徵和區段以供資料收集： 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> 繼續加深對產品功能、工具和報表的瞭解與熟悉 </td> 
   <td colname="col3"> 業務團隊 </td> 
  </tr> 
  <tr valign="top"> 
   <td colname="col1"> 後續通訊 </td> 
   <td colname="col2"> 定期排程通訊，以隨時掌握您的Audience Manager使用者體驗 </td> 
   <td colname="col3"> 業務和技術團隊 </td> 
  </tr> 
 </tbody> 
</table>
...
* 瞭解自訂報表；
* 如何取得產品支援
* 回應或徵求功能要求、錯誤和使用者意見回饋；
* 加深對Audience Manager功能和報告的熟悉。

## 程式碼實施 {#code-implementation}

Audience Manager使用Data Integration Library([!DNL DIL])，以接收受眾資料。

有關如何使用的詳細說明 [!DNL DIL]，請參閱 [取得和實作DIL程式碼](../dil/dil-overview.md).

### 參與者

合作夥伴解決方案可直接與您的技術團隊合作，協助部署程式碼、解決最終問題以及滿足其他要求。

## 實作後支援 {#post-implementation-support}

我們的共同努力不會止步於最終部署。 實施完成後，我們的客戶管理團隊會接管。

產品實作程式完成後，客戶經理會提供持續支援和諮詢服務。 您可以預期與帳戶管理員定期開會。 這些會議可確保您從Audience Manager中獲得最大的使用量和價值。

聯絡我們 [此處](https://www.adobe.com/products/audiencemanager.html) 以取得詳細資訊，並開始使用Audience Manager。
