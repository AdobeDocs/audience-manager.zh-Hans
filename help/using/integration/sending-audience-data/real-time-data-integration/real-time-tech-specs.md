---
description: 第三方内容提供商可望根据这些技术规范与Audience Manager交换数据。 实时（同步）集成可在用户访问您的网站或在您的网站上执行操作时近乎实时地传输数据。 技术、工程或开发团队应使用此材料来帮助设置与Audience Manager的实时数据传输。
...
第三方内容提供商可望根据这些技术规范与Audience Manager交换数据。 实时（同步）集成可在用户访问您的网站或在您的网站上执行操作时近乎实时地传输数据。 技术、工程或开发团队应使用此材料来帮助设置与Audience Manager的实时数据传输。
