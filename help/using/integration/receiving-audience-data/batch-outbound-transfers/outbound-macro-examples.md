...
>[!NOTE]
>
>在表中，**boldface**&#x200B;类型用其相关输出标识每个宏。 对于格式示例，已添加`<` `>`符号以帮助在视觉上分隔每个宏。
...
<table id="table_B5073597219B470298EE614902DACAE8"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>格式： <code> &lt;SYNC_TYPE&gt;_&lt;ORDER_ID&gt;_ &lt;DPID&gt;_&lt;SYNC_MODE&gt;_&lt;TIMESTAMP&gt;.sync </code> </p> <p>输出： <code> ftp_215_ 888_iter_1449756724.sync </code> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> MASTER_DPID </code> </p> </td> 
   <td colname="col2"> <p>格式： <code> &lt;SYNC_TYPE&gt;_&lt;ORDER_ID&gt;_&lt;DPID&gt;_ &lt;MASTER_DPID&gt;_&lt;SYNC_MODE&gt;_&lt;TIMESTAMP&gt;.sync </code> </p> <p>输出： <code> ftp_215_888_ 20915_iter_1449756724.sync </code> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> ORDER_ID </code> </p> </td> 
   <td colname="col2"> <p>格式： <code> &lt;SYNC_TYPE&gt;_ &lt;ORDER_ID&gt;_&lt;DPID&gt;_&lt;SYNC_MODE&gt;_&lt;TIMESTAMP&gt;.sync </code> </p> <p>输出： <code> ftp_ 215_888_iter_1449756724.sync </code> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> SYNC_MODE </code> </p> </td> 
   <td colname="col2"> <p>格式： <code> &lt;SYNC_TYPE&gt;_&lt;ORDER_ID&gt;_&lt;DPID&gt;_ &lt;SYNC_MODE&gt;_&lt;TIMESTAMP&gt;.sync </code> </p> <p>输出： </p> <p> 
     <ul id="ul_F63D7B78AF1246639D6ED85C1621B17C"> 
      <li id="li_4D0D7B4D047345FE861FCBA2BD0408ED">全部： <code> ftp_215_888_ full_1449756724.sync </code> </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>格式： <code> &lt;SYNC_TYPE&gt;_&lt;ORDER_ID&gt;_&lt;DPID&gt;_&lt;SYNC_MODE&gt;_ &lt;TIMESTAMP&gt;_&lt;admin&gt;&lt;.sync&gt; </code> </p> <p>输出： <code> ftp_215_888_iter_ 1449756724.sync </code> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_ABC31B3D660D47969E111EBC734D5BBC"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>格式： <code> &lt;ORDER_ID&gt; &lt;TAB&gt;&lt;SYNC_TYPE&gt; </code> </p> <p>输出： <code> 888 full.sync </code> </p> <p>在输出中，非打印制表符将分隔每个元素。 </p> </td>
  </tr>
 </tbody>
</table>
...
<table id="table_408C6DD2B9D54550B003EAC93562E64F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>格式： <code> &lt;DP_UUID&gt;&lt;TAB&gt; &lt;UUID&gt; </code> </p> <p>输出： <code> 123456 07955261652886032950143702505894272138 </code> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> DP_UUID_LIST </code> </p> </td> 
   <td colname="col2"> <p>格式： <code> &lt;UUID&gt;&lt;TAB&gt; &lt;DP_UUID_LIST;separator=TAB&gt; </code> </p> <p>输出： <code> 07955261652886032950143702505894272138 DP_UUID1 DP_UUID2 DP_UUID3 </code> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>格式： </p> <p> <code> &lt;PID&gt;&lt;TAB&gt;&lt;UUID&gt;&lt;TAB&gt;&lt;DP_UUID&gt;&lt;TAB&gt; &lt;SET_ATTRIBUTES&gt;&lt;TAB&gt;&lt;OPT_OUT&gt;&lt;TAB&gt;&lt;SEGMENT_LIST:{seg|&lt;seg.type&gt;,&lt;seg.alias&gt;,&lt;OUTPUT_ATTRIBUTE_VALUE&gt;,&lt;seg.lastUpdateTime&gt;&amp;}&gt; </code> </p> <p>输出： </p> <p> <code> 1159 00088008579683653741516297509717335000 17t0aj01b120hp 1 0 5,103714,1,1344114661000&amp;5,103713,1,1343250661000 </code> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> TAB </code> </p> </td> 
   <td colname="col2"> <p>格式： <code> &lt;DP_UUID&gt;&lt;TAB&gt;&lt;DP_UUID_LIST;separator=TAB&gt; </code> </p> <p>输出： <code> 123456 UUID1 UUID2 UUID3 </code> </p> <p>在输出中，非打印制表符将分隔每个元素。 </p> </td> 
  </tr>
  <tr>
...
为了帮助您了解`DPUUID`宏如何输出数据，我们假设有2个`DPID`映射到`DPUUID`，如下所示：

* DPID `1111`映射到DPUUID `AAAA` （时间戳= 1）和`BBBB` （时间戳= 2）。
* DPID `2222`映射到DPUUID `CCCC`。

根据这些条件，下表列举了一些可能的格式字符串及其输出。
...
<table id="table_6A6D94F994C1475BB09126BA0B815B1F"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>对于所有DPID，最多返回1个映射 </p> </td> 
   <td colname="col2"> <p> <code> &lt;DPUUIDS; format="dpids=1111,2222|maxMappings=1|format=json"&gt; </code> </p> </td> 
   <td colname="col3"> <p> <code> [["1111","BBBB"],["2222","CCCC"]] </code> </p> <p>对于DPID <code> 1111 </code>，宏仅映射到DPUUID <code> BBBB </code>，因为该ID具有更大的时间戳。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p> <code> [["2222","CCCC"]] </code> </p> <p>即使<code> maxMappings=2 </code>，此宏也只返回1个DPID到DPUUID的映射，因为指定的DPID只有一个DPUUID。 </p> </td> 
  </tr> 
 </tbody> 
</table>
