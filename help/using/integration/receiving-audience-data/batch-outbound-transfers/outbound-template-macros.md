...
下表列出并描述了可在文件名中使用的宏以及用于定义标题字段的宏。 有关代码示例，请参阅 [出站宏示例](../../../integration/receiving-audience-data/batch-outbound-transfers/outbound-macro-examples.md)。
...
<table id="table_C353AF028E0A4944A8727FD01C94FDB6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 允许为出站订单创建多行标题。 </p> </td> 
  </tr> 
  <tr> 
...
<p>上述示例中的最后三位数字(001,002,003)是SPLITNUM标识符。</p> </td> 
  </tr> 
  <tr> 
...
<table id="table_5C6F9678CFF34C5EB67BA1DEA0479F1D"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="term"> 数据提供者唯一用户标识符 </span>。 </p> <p>这是您将数据发送到出站文件中的数据合作伙伴的ID。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>此宏组合会创建一个条件语句，其中列出用户所属和已从中删除的区段。 如果两个条件都不满足或没有数据，则返回空字符串。 </p> </td> 
  </tr> 
  <tr> 
