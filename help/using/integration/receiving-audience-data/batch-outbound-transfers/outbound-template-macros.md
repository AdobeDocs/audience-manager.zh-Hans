...
表列表和描述了可在文件名中使用的宏以及定义标题字段。 有关代码示例，请参 [阅出站宏示例](../../../integration/receiving-audience-data/batch-outbound-transfers/outbound-macro-examples.md)。
...
<p>上例中的最后三位数字(001,002,003)是SPLITNUM标识符。</p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>一个10位的UTC Unix时间戳。 </p> <p>也可以按照Java日期／时 <code> &lt;TIMESTAMP; format="YYYYMMDDhhmmss"&gt; </code> 间戳格式化规则设置格式。 </p> </td> 
  </tr>
...
用于格式化数据文件内容的宏。 有关代码示例，请参 [阅出站宏示例](../../../integration/receiving-audience-data/batch-outbound-transfers/outbound-macro-examples.md)。
...
<table id="table_5C6F9678CFF34C5EB67BA1DEA0479F1D"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>插入右大括号}字符。 </p> </td> 
  </tr> 
  <tr> 
