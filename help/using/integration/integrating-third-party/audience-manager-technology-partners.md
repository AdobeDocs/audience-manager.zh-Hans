...
此页仅包含当前Audience Manager[服务器到服务器集成](/help/using/features/destinations/add-edit-segments.md)。  有关集成的更多信息，请参阅其[Adobe Exchange](https://www.adobeexchange.com/experiencecloud.html)列表（如果可用），或联系您的Adobe顾问或客户关怀部门。
