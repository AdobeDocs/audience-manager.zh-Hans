...
本页仅包括当前Audience Manager [服务器到服务器集成](/help/using/features/destinations/add-edit-segments.md) 。  有关集成的详细信息，请参阅其 [Adobe Exchange列表](https://www.adobeexchange.com/experiencecloud.html) （如果可用），或与Adobe顾问或客户关怀联系。
...
| Crosswise | 27/02/2017 | 是 | 否 | 否 | 否 |
| 华盛顿特区AudienceOne | 27/02/2017 | 是 | 否 | 否 | 否 |
...
| Turn / Amobee | 03/03/2027 | 否 | 否 | 否 | 是 |
...
| Yeildex | 21/08/2017 | 是 | 否 | 否 | 否 |
| YieldMo | 03/03/2017 | 否 | 否 | 否 | 否 |
| 由美 | 31/05/2017 | 否 | 否 | 否 | 否 |