...
[!UICONTROL Cross-Device Options]允许您选择经过身份验证和未经身份验证的用户，并利用其跨设备配置文件进行分段。 这些选项可帮助您识别并联系共享设备上的特定用户。 有关匿名用户和经过身份验证用户的详细信息，请参阅Audience Manager中的[访客身份验证状态](../../reference/visitor-authentication-states.md)。
...
<table id="table_4CE2DD312F54480E96BEAF72800789FB"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>告知<span class="keyword"> Audience Manager</span>从上次登录设备的用户的已验证配置文件中读取数据。 </p> <p>选中后，如果用户是匿名的，则<span class="keyword"> Audience Manager</span>不会将新特征数据写入经过身份验证的配置文件。 身份验证后，新特征数据将写入用户经过身份验证的配置文件。 </p> </td>
  </tr> 
  <tr> 
...
<tr> 
   ...
   <td colname="col2"> <p>这些选项允许您根据第三方供应商提供的设备图技术构建合并规则。 第三方设备图提供： </p> <p> 
     ...
     </ul> </p> <p>要使用这些选项，您必须是已与<span class="keyword"> Audience Manager</span>集成的设备图提供的客户。 请联系您的客户经理以了解更多信息或开始使用。 </p> </td>
  </tr>
 </tbody>
</table>
