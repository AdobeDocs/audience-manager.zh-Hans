---
description: 此頁面僅包含目前的伺服器對伺服器整合。 如需整合的詳細資訊，請參閱其Adobe交換清單（若有），或聯絡您的Adobe顧問或客戶服務。
...
此頁面包含目前版本 [!DNL Audience Manager] [以裝置為基礎的目的地](/help/using/features/destinations/add-device-based-destinations.md) 僅限。 在 [!DNL Audience Manager]， [!UICONTROL device-based destinations] 也稱為 [!UICONTROL server-to-server destinations]. 如需整合的詳細資訊，請參閱其 [Adobe交換](https://exchange.adobe.com/experiencecloud.html) 列出（若有）或聯絡您的 [!DNL Adobe] 顧問或客戶服務。


* **上次更新時間** =顯示此專案的上次更新日期 [!UICONTROL device-based destination].
* **更新** =指示是否 [!DNL Audience Manager] 將資料即時或批次(1xday)傳送至此 [!UICONTROL destination].
* **取消細分** =取消細分說明取消資格並從中移除裝置設定檔的程式 [!UICONTROL segments]. 您從移除裝置設定檔的功能 [!UICONTROL segment] 取決於用來建立 [!UICONTROL Profile Merge Rule]. 取消細分也會用在的內容中 [!DNL GDPR] 刪除請求。 讀取 [設定檔合併規則與裝置取消細分程式](/help/using/features/profile-merge-rules/merge-rule-unsegment.md) 和 [透過取消細分功能Audience Manager合作夥伴](/help/using/overview/data-security-and-privacy/data-privacy-requests.md#aam-partners-with-unsegmentation). [!DNL Audience Manager] 傳送取消細分資訊至 [!UICONTROL destinations] 標示為 **是** 下方的。
* **正在接收 [!DNL IAB TCF] 同意訊號** = [!DNL Audience Manager Plug-in for IAB TCF] 可讓您轉寄 [!DNL IAB TC] 字串連線至啟用合作夥伴，同時尊重使用者的隱私權選擇。 讀取 [適用於IAB TCF的Audience Manager外掛程式](/help/using/overview/data-security-and-privacy/aam-iab-plugin.md).
* **[!DNL ICDS]** =此欄會列出支援的合作夥伴 [!UICONTROL Instant Cross-Device Suppression]. 閱讀關於 [即時跨裝置隱藏](/help/using/features/profile-merge-rules/instant-cross-device-suppression.md).
* **行動裝置ID** =此欄列出可從接收行動裝置ID的合作夥伴 [!DNL Audience Manager].


| 集成 | 上次更新 | 更新 | 取消細分 | 正在接收 [!DNL IAB TCF] 同意訊號 | [!DNL ICDS] | 移动设备 ID |
|----------------------------------------------------------|------------|-----------|-----------|-----------------------------------|------|-------------------|
| [!DNL 4C Insights] | 26/09/2018 | 1xday | 是 | 否 | 否 | 是 |
| [!DNL 4info] | 09/02/2017 | 1xday | 否 | 否 | 否 | 是 |
| [!DNL AcuityAds] | 09/02/2017 | 即時 | 是 | 否 | 是 | 否 |
| [!DNL Adara] | 17/02/2017 | 即時 | 是 | 否 | 否 | 否 |
| [!DNL Addictive Mobility] | 22/02/2017 | 1xday | 是 | 否 | 是 | 是 |
| [!DNL Adelphic] | 22/02/2017 | 1xday | 否 | 否 | 否 | 是 |
| [!DNL AdForm] | 22/02/2017 | 即時 | 是 | 否 | 是 | 是 |
| [!DNL AdGear] | 22/02/2017 | 即時 | 是 | 否 | 是 | 否 |
...
| [!DNL AOL ONE] | 02/03/2017 | 即時 | 是 | 否 | 否 | 是 |
| [!DNL AppNexus] | 02/03/2017 | 即時 | 是 | 否 | 是 | 是 |
| [!DNL AppNexus Yieldex] | 10/08/2017 | 1xday | 是 | 否 | 否 | 否 |
| [!DNL Artsai] (formerly [!DNL Adxcel]) | 27/01/2020 | 1xday | 否 | 否 | 否 | 是 |
| [!DNL Atedra]/[!DNL AdStanding] | 02/03/2017 | 即時 | 是 | 否 | 是 | 否 |
| [!DNL Avocet] | 06/12/2017 | 1xday | 否 | 否 | 否 | 否 |
| [!DNL Bidtellect] | 03/03/2017 | 即時 | 是 | 否 | 否 | 否 |
...
| [!DNL Clearstream.tv] | 27/02/2017 | 即時 | 是 | 否 | 否 | 否 |
| [!DNL Collective AMP Platform] | 27/02/2017 | 1xday | 否 | 否 | 否 | 否 |
| [!DNL Criteo] | 27/02/2017 | 即時 | 否 | 是 | 否 | 是 |
...
| [!DNL Dstillery] ([!DNL FKA Media6]) | 02/03/2017 | 即時 | 是 | 否 | 否 | 是 |
...
| [!DNL Exponential] | 27/02/2017 | 即時 | 是 | 否 | 是 | 否 |
...
| [!DNL Flybits] | 31/07/2020 | 即時 | 是 | 否 | 是 | 是 |
...
| [!DNL Infectious Media] | 03/03/2017 | 即時 | 是 | 否 | 是 | 否 |
...
| [!DNL Quantcast] | 13/02/2017 | 即時 | 是 | 否 | 否 | 否 |
| [!DNL RhythmOne / RadiumOne] | 13/02/2017 | 即時 | 是 | 否 | 否 | 是 |
| [!DNL Remerge] | 31/05/2017 | 即時 | 是 | 否 | 是 | 是 |
| [!DNL Resonate] | 17/02/2017 | 1x/天 | 是 | 否 | 否 | 否 |
| [!DNL RevJet] | 17/02/2017 | 1x/天 | 否 | 否 | 否 | 否 |
| [!DNL RocketFuel] | 17/02/2017 | 即時 | 是 | 否 | 是 | 是 |
| [!DNL Rubicon] |  | 即時 | 是 | 是 | 否 |  |
| [!DNL RUN] | 17/02/2017 | 1xday | 是 | 否 | 否 | 否 |
| [!DNL RTB House] | 04/02/2021 | 即時 | 是 | 否 | 是 | 是 |
...
| [!DNL Slickdeals] | 04/09/2018 | 即時 | 是 | 否 | 否 | 是 |
| [!DNL Smart Adserver] | 31/07/2017 | 即時 | 是 | 否 | 是 | 是 |
| [!DNL So-net Media Networks Logicad] |  | 1x/天 | 是 | 否 | 否 |  |
| [!DNL Sonobi] | 28/03/2017 | 即時 | 是 | 否 | 是 | 否 |
| [!DNL SpecificMedia] | 03/03/2017 | 即時 | 否 | 否 | 否 | 否 |
| [!DNL SpongeCell] | 03/03/2017 | 即時 | 是 | 否 | 是 | 是 |
| [!DNL SpotX] | 16/03/2018 | 1xday | 否 | 是 | 否 | 是 |
| [!DNL Stroer] | 03/03/2017 | 1xday | 是 | 否 | 否 | 否 |
| [!DNL SundaySky] | 03/03/2017 | 即時 | 是 | 否 | 是 | 否 |
...
| [!DNL Triple Lift] | 03/03/2017 | 即時 | 否 | 是 | 否 | 否 |
| [!DNL TrueX] | 11/01/2018 | 即時 | 是 | 否 | 否 | 是 |
| [!DNL TubeMogul] | 03/03/2017 | 即時 | 是 | 否 | 是 | 否 |
| [!DNL Turn] / [!DNL Amobee] | 03/03/2027 | 即時 | 否 | 否 | 否 | 是 |
| [!DNL Twenga] | 29/10/2018 | 即時 | 是 | 否 | 否 | 否 |
| [!DNL Twitter Custom Audiences] | 27/03/2017 | 即時 | 是 | 否 | 是 | 否 |
...
| [!DNL Wikibuy] | 04/08/2018 | 即時 | 是 | 否 | 否 | 是 |
...
| [!DNL Yieldex] | 21/08/2017 | 視情況而定 | 是 | 否 | 否 | 否 |
| [!DNL YieldMo] | 03/03/2017 | 1xday | 否 | 否 | 否 | 否 |
| [!DNL Yume] | 31/05/2017 | 1xday | 否 | 否 | 否 | 否 |
| [!DNL Zeta] / [!DNL Sizmek DSP] / [!DNL RocketFuel] | 17/02/2017 | 即時 | 是 | 否 | 是 | 是 |