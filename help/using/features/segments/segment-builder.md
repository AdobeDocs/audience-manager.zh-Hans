...
| **[!UICONTROL Data Source]** | 将区段与特定数据提供商关联。<br> 使用第一个下拉菜单在Audience Manager数据源、Adobe Analytics报表包或两者之间筛选。 然后，使用第二个下拉菜单选择数据源。<br> 如果您未使用Adobe Analytics报表包，则数据源类型选择器会处于禁用状态，并且仅默认为Audience Manager数据源。 |
