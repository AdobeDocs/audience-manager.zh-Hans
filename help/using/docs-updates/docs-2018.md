---
description: 2018年和前几年发布的一列表新文件或修订文件。 其中包括对 Audience Manager 文档进行的次要更新，这些更新可能未包含在 Experience Cloud 发行说明中。
seo-description: 2018年和前几年发布的一列表新文件或修订文件。 其中包括对 Audience Manager 文档进行的次要更新，这些更新可能未包含在 Experience Cloud 发行说明中。
...
<table id="table_9017F44983CC49E888BE3470430D7ACB"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>我们更新了文档，以包含测试组的新搜索和筛选功能。 请参阅<a href="../features/audience-lab/audience-lab.md#search-and-filter">搜索和筛选测试组</a>部分。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_BAB960ED4DA1432087A162210681B225"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>对于使用Audience Manager和Adobe Analytics的客户：Audience Manager用户界面不允许您删除从Analytics报表包自动创建的数据源。 使用<a href="https://docs.adobe.com/content/help/en/core-services/interface/about-core-services/core-services-landing.html" format="https" scope="external">核心服务</a>取消映射这些数据源。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_01EF3D23C50F4635BFBD55F9D6CE1752"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>从版本8.0开始，<span class="wintitle">DIL</span>对<a href="https://docs.adobe.com/content/help/zh-Hans/id-service/using/home.html" format="https" scope="external"><span class="keyword">Adobe Experience Platform标识服务</span></a>、版本3.3或更高版本具有硬依赖性。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_2D7B56FFB0134D18894E0493043C32BD"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>GET请求的最大内容长度为8K。 您可以通过访问此页来阅读有关GET和POSTAPI方法的更多信息。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9166897029124C6782E0DE3D816CEA49"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在您<a href="../features/traits/create-onboarded-rule-based-traits.md#create-rules-based-or-onboarded-traits">在UI中创建特征</a>后，用户将约4小时开始符合基于规则的特征。 阅读文档，了解有关特质资格的更多信息。 </p> </td> 
  </tr> 
  <tr> 
