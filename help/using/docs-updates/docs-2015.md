...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> 针对CPM数据馈送<a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-buyer-billing.md#cost-attribution">的</a>帐单和展示次数分配 </p> </td> 
   <td colname="col2"> <p>有关如何为其他CPM数据馈送分配展示的说明。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> 针对固定费用数据馈送<a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-buyer-billing.md">的</a>帐单和展示分配 </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> 数据提供程序<a href="../features/audience-marketplace/marketplace-data-providers/marketplace-create-manage-feeds.md#discounts">的</a>折扣 </p> </td> 
   <td colname="col2"> <p>折扣让数据提供商能够降低选定买方的数据馈送价格。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> 数据购买者<a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#buyer-discount">的</a>折扣 </p> </td> 
...
<table id="table_E60674ACBD254365A73AB47FB840A333"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 使用主营销配置文件并通过访客ID服务将声明的ID传递给<span class="keyword"> Audience Manager</span>时，<span class="keyword"> Analytics</span>客户需要设置一个集成代码。 </p> <p>此文档已弃用，已由<a href="../features/profile-merge-rules/merge-rules-start.md">创建跨设备数据Source</a>取代。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_D4F6BB8E192E4C1BAF1B505541A1E56E"> 
      ...
      <li id="li_85A63519222A4423B8D7A3FF90929741">向<code> declaredId</code>变量添加了注释。 使用访客ID服务时，请使用<code> setCustomerIDs</code>而不是DIL来设置ID。 查看<a href="https://experienceleague.adobe.com/docs/id-service/using/reference/authenticated-state.html" format="https" scope="external">客户ID和身份验证状态</a>。 </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_E8CD8CF9B9D3439C99AC688AFD712621"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>添加了以下注释： </p> <p> <p>注意： <span class="keyword"> Audience Manager</span>不支持将入站S3存储桶存储为.zip文件。 </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-reporting.md">报告常见问题解答</a> </p> </td> 
...
<table id="table_A9AF62AC1D434B87BF4CB29BB1FE9EE0"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-reporting.md">报告常见问题解答</a> </p> </td> 
   <td colname="col2"> <p>添加了一个新的常见问题解答，该问题解答解释了在AAM中比较集客接收和报表时，成功处理的记录数量可能不同的原因。 </p> <p>添加了一个新的常见问题解答，其中解释了为什么跨设备载入特征的不重复特征数高于载入的总记录数。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../reference/system-components/components-overview.md">系统组件</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在“限制和规则”部分中添加了以下信息： </p> <p> 
     <ul id="ul_2451A3EAA05E4961AA7EA90026F353F5"> 
      ...
      <li id="li_BAEC874C0B6E4232A83C7228E84A7AD0"> <p>对于广告频率限制用例，您可以创建类似于以下内容的区段规则： </p> <p> <code> (frequency([1000T] &lt;= 2D) &gt;= 5)?</code> </p> <p>此表达式包含在过去2天内实现ID为“1000”的特征超过5次的所有用户。 </p> <p>您可以将此区段发送到广告服务器，然后在广告服务器的区段上包含NOT来实现上限。 这种方法在Audience Manager中实现了更好的性能，同时仍能实现相同的频率封顶目的。 </p> </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A52FC2668EEE4100A71B52267B7215F9"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>配置文件合并客户支持 </p> </td> 
   <td colname="col2"> <p>添加了额外的步骤来说明如何将声明的ID的使用添加到DIL和Mobile SDK。 </p> <p>此文档已弃用，并被<a href="../features/profile-merge-rules/merge-rules-start.md">替换为创建跨设备数据Source</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../integration/sending-audience-data/batch-data-transfer-explained/inbound-file-contents.md">入站数据文件内容：语法、变量和示例</a> </p> </td> 
