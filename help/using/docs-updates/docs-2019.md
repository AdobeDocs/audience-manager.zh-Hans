...
| 主题 | 描述 |
|--- |----|
| [Audience ManagerAPI](/help/using/api/rest-api-main/rest-api-main.md) | 我们正在将所有API](/help/using/api/api-swagger-migration.md)从产品文档[迁移到Swagger API。 我们迁移的最新两个API是： <ul><li>[算法模型API](https://bank.demdex.com/portal/swagger/index.html#/Algorithmic_Models_API)</li><li>[派生信号API](https://bank.demdex.com/portal/swagger/index.html#/Derived_Signals_API)</li></ul> |
