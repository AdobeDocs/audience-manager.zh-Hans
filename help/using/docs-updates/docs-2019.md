...
| [Audience Marketplace计费示例](../features/audience-marketplace/marketplace-data-buyers/marketplace-buyer-billing.md#billing-examples) | We added a new example, Case 3, where we detail how billing works for segments with activation and modeling use cases. |
...
| 主题 | 描述 |
|--- |----|
| [目标主页](/help/using/features/destinations/destinations-home.md) | The Destinations landing page has a new look. [](https://bank.demdex.com/portal/destinations/all)Read this page for information about the new layout. |
