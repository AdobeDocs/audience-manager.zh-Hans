...
| 主题 | 描述 |
|---- |----|
| [Audience Manager中的辅助功能](../overview/accessibility-in-aam.md) | 辅助功能是指使软件产品可用的一系列功能，使具有各种残疾的用户尽可能少地使用这些功能，如视觉、听觉、认知、运动或其他类型。 为了使Audience Manager更易于所有人使用，我们开发了对多种辅助功能的支持，详见本文。 |
