...
<table id="table_020B4F263E1C4C55BDF10B15436B0471"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://docs.adobe.com/content/help/en/core-services/interface/more-resources/dns-prefetch.html" format="https" scope="external"> 将DNS预获取用于不同的Experience Cloud解决方案</a> </p> </td> 
...
[!DNL Audience Manager]发行说明和文档更改的链接。 有关[!DNL Experience Cloud]级别的旧更改的存档，请参阅[以前的发行说明](https://docs.adobe.com/content/help/en/release-notes/experience-cloud/current.html)部分。
