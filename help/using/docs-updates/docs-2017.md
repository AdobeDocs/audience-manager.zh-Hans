...
<table id="table_6AAE9EF4DE76467FAFEDAB418B5A0207"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>出于参考目的，我们添加了保留属性 <code> d_dst_filter</code> 和 <code> d_rs</code> 记录在案 <code> d_</code> 属性。 我们建议不要创建使用保留属性的特征。 Adobe可以随时更改保留的属性。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>更新了入站数据文件中的已接受和禁止字符。 我们还添加了一个矩阵表，以显示正确格式入站文件的示例，具体取决于您要导入的ID类型以及向配置文件添加特征的方法。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_18C3AA0411CC4CBC98531BE735934E30"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md"> DCS API 调用支持的属性</a> </p> </td> 
   <td colname="col2"> <p>添加了 <code> d_cts</code> 作为DCS请求可用键列表中的可选参数。 要启用此功能，您必须联系Adobe Audience Manager顾问或客户关怀团队。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_8BA284C2CD324D5F988D9209D9078BE1"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>找出原因 <span class="wintitle"> 可操作的日志文件</span> 是将DCM日志文件导入的推荐方法 <span class="keyword"> Audience Manager</span> 并了解如何开始使用该功能。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>添加了关于需要执行哪些操作才能启用的步骤7 <span class="wintitle"> 可操作的日志文件</span> 在将DCM数据文件导入到 <span class="keyword"> Audience Manager</span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A56DCFF49B78467B9600A8CE8F608094"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"><i>此功能已被弃用。</i> <p>用于控制数据如何发送到的新配置 <span class="keyword"> Experience Cloud设备协作</span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_5172A5D65C2841AE8B102B57F00C5FE7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>介绍取消分段如何处理的新内容 <span class="wintitle"> 配置文件合并规则</span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder-data.md"> 区段生成器中的特征和区段人口数据</a> </p> </td> 
   <td colname="col2"> <p>已使用新定义进行修订，该定义考虑了 <span class="wintitle"> 配置文件合并规则</span> 会影响报表数量。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_C2E33C099A3F4942AA1BCCC5B7B4D05E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 的 <b><span class="uicontrol"> 编辑</span></b> 工作流允许您更改文件夹特征的数据源。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder-data.md"> 区段生成器中的特征和区段人口数据</a> </p> </td> 
   <td colname="col2"> <p>将量度更改为 <span class="wintitle"> 特征人口总数</span> 从 <span class="wintitle"> 独特特征实现</span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder.md"> 从区段中删除特征</a> </p> </td> 
   <td colname="col2"> <p>有关如何使用 <span class="wintitle"> 区段生成器</span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_FB58595763214BB5BBC778733FF0778C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>我们文档中新增了一节，重点介绍了 <span class="wintitle"> Audience Lab</span> 功能。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/audience-lab/audience-lab-use-cases.md#compare-models"> 在Audience Lab中比较模型</a> </p> </td> 
   <td colname="col2"> <p>您可以在 <span class="keyword"> Audience Manager</span>. <span class="wintitle"> Audience Lab</span> 提供了一种比较活跃模型中客户转化率的简便方法。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/audience-lab/audience-lab-use-cases.md#testing-creatives"> 跨目标测试创意</a> </p> </td> 
   <td colname="col2"> <p>使用 <span class="wintitle"> Audience Lab</span> 为了测量创意人员在不同目标之间促进的转化次数。 此用例还允许您根据自然发生的转化来测量创作元素的转化。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../faq/faq-profile-merge.md"> 配置文件合并规则常见问题解答</a> </p> </td> 
   <td colname="col2"> <p>添加了一个新的常见问题解答，以帮助回答常见问题 <span class="wintitle"> 配置文件合并规则</span> 和设备图问题。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9D6D2244D23648F9AC4D1F5E40BDCF14"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>现在，DCS HTTP响应调用包含 <code> tid</code> 字段。 当出现问题时，可使用此字段进行调试。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2" morerows="2"> <p>添加了注释，以阐明7天和30天的回顾期仅适用于星期日 <b><span class="uicontrol"> 日期至</span></b> 日期。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>修订了内容以指示以下内容： </p> 
    <ul id="ul_99C2ACF7B28F442B8F66A40525F1CAE3"> 
     ...
     <li id="li_5012C420AC544B858246598575E59D8C">在上传之前，必须先对文件进行gzip压缩，并且 <code> .gz</code> 文件扩展名。 </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/segments/segment-builder-data.md"> 区段生成器中的特征和区段人口数据</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>添加了有关原因的新文档 <span class="keyword"> Audience Manager</span> 致电 <code> demdex.net</code> 域。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="https://experienceleague.adobe.com/docs/core-services/interface/ec-cookies/cookies-am.html" format="https" scope="external"> Audience Manager Cookie</a> </p> </td> 
...
<table id="table_237E64BBFEF84A8E97EE61E6CD5F371F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md"> DCS API 调用支持的属性</a> </p> </td> 
   <td colname="col2"> <p>更新了关键变量前缀，前缀为 <code> _p</code>，在Audience Manager中标识专用参数。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在 <b><span class="uicontrol"> 浏览所有特征</span></b> 高级搜索。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>本节包含支持 <span class="wintitle"> 配置文件链接</span> 和第三方设备图选项。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_020B4F263E1C4C55BDF10B15436B0471"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2">添加了可选的文件名元素 <code> PID-ALIAS</code> 中。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>修订了描述，并添加了指向 <code> containerSNID</code> 财产 <code> DIL.create</code>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/addressable-audiences.md#addressable-audience-metrics"> 可寻址受众量度</a> </p> </td> 
...
<table id="table_8D727AAADA224AF687E41C26CBFB1CC2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>更新了处理的移动设备ID(DAID)的预期格式 <span class="keyword"> Audience Manager</span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>添加了描述 <span class="keyword"> Experience Cloud</span> <span class="wintitle"> 组织ID</span>，包括有关如何查找该变量的信息。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 
...
链接到 [!DNL Audience Manager] 发行说明和文档更改。 有关旧更改的存档，请访问 [!DNL Experience Cloud] 级别，请参阅 [以前的发行说明](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html) 中。
