...
<table id="table_18C3AA0411CC4CBC98531BE735934E30"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md"> DCS API 调用支持的属性</a> </p> </td> 
   <td colname="col2"> <p>在 <code> d_cts</code> DCS请求的可用密钥列表中添加为可选参数。 要启用该功能，您必须联系Adobe Audience Manager顾问或客户关怀。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>关于如何将Audience Manager细分发送到Analytics的新内容。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_8BA284C2CD324D5F988D9209D9078BE1"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>了解为何 <span class="wintitle"> 建议将DCM日志文件</span> 导入到Audience Manager中时使用“可操作日志文件” <span class="keyword"></span> ，并了解如何开始使用该功能。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>添加了步骤7，介绍在将DCM数据文件导入 <span class="wintitle"> 到Audience Manager中后</span> ，您需要执行哪些操作来启用可操作的日志 <span class="keyword"> 文件</span>。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A56DCFF49B78467B9600A8CE8F608094"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>新配置，用于控制如何将Experience Cloud发 <span class="keyword"> 送到设备合作社</span>。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_FB58595763214BB5BBC778733FF0778C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>您可以在Audience Manager中使用几种不同的模型类型和 <span class="keyword"> 源</span>。 <span class="wintitle"> 受众实验</span> 优惠是比较客户在活动模型中的转化率的简单方法。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9D6D2244D23648F9AC4D1F5E40BDCF14"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>添加了新文档，说明 <span class="keyword"> Audience Manager</span> 为何对域进行 <code> demdex.net</code> 调用。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="https://docs.adobe.com/content/help/zh-Hans/core-services/interface/ec-cookies/cookies-am.html" format="https" scope="external"> Audience Manager Cookie</a> </p> </td> 
...
<table id="table_237E64BBFEF84A8E97EE61E6CD5F371F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md"> DCS API 调用支持的属性</a> </p> </td> 
   <td colname="col2"> <p>更新了密钥变量前缀， <code> _p</code>以标识Audience Manager中的私有参数。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_8D727AAADA224AF687E41C26CBFB1CC2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>已使用Audience Manager处理的移动设备ID(DAID)的预期格式进行更 <span class="keyword"> 新</span>。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>添加了描述Experience Cloud组 <span class="keyword"> 织</span> ID的新条目 <span class="wintitle"></span>，包括有关如何查找它的信息。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 
...
发行说明 [!DNL Audience Manager] 和文档更改的链接。 有关级别上较旧更改的存 [!DNL Experience Cloud] 档，请参阅“上 [一发行说明](https://docs.adobe.com/content/help/zh-Hans/release-notes/experience-cloud/current.html) ”部分。
