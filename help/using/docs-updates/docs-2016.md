...
<table id="table_D16570793032445FBC18F662BF9DDA7A"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> 记录了算法发现过程中的额外步骤。 此步骤说明了算法特征在多个数据处理周期中的演变。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>包含有关白名单的新条目 <span class="keyword"> Audience Manager</span> IP和FTP地址。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>文档描述了一种新的DIL方法，允许您将数据发送到 <span class="keyword"> Audience Manager</span> 来自Google的Universal Analytics。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D83514BA7F5745DA80D6135804D5BD5F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <span class="keyword"> Audience Manager</span> 处理访客ID身份验证状态 <code> UNKNOWN</code> 和 <code> LOGGED_OUT</code> 同样的方式。 本文档提供了有关如何处理的更多信息 <code> setCustomerID</code> 事件调用。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <a href="../reference/cid.md"> CID 取代 DPID 和 DPUUID </a> </td> 
   <td colname="col2"> 您现在可以将客户ID集成代码用于移动标识符数据源。 对于Android设备，使用DSID_20914 CID_IC；对于iOS设备，使用DSID_20915 CID_IC。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../reference/ids-in-aam.md"> Audience Manager 中的 ID 索引 </a> </p> </td> 
   <td colname="col2"> <p>请参阅本文档，获取 <span class="keyword"> Audience Manager</span> ID。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-audience-lab.md"> Audience Lab 常见问题解答 </a> </p> </td> 
   <td colname="col2"> <p>有关 <span class="wintitle"> Audience Lab</span> 功能。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/addressable-audiences.md#date-ranges"> 可寻址受众和目标中的日期范围 </a> </p> </td> 
   <td colname="col2"> <p>新内容描述时间间隔如何工作 <span class="wintitle"> 可寻址受众</span> 和 <span class="wintitle"> 目标</span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>介绍 <span class="wintitle"> 目标</span> 登陆页面。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2">添加了通过OAuth 2.0协议保护实时出站数据传输的功能。 联系您的 <span class="keyword"> Adobe Audience Manager</span> 顾问。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>修订后，请注意 <code> GA.init()</code> 无法与最新版本的Google分析代码一起使用， <code> analytics.js</code>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <i>此功能已被弃用。</i><p>已修订以包含有关 <span class="keyword"> Adobe Experience Cloud设备协作</span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2">概述 <span class="wintitle"> 数据信息库</span> (DIL)。 </td> 
  </tr> 
  <tr> 
...
<table id="table_50CD90671E4B4C50A624AC0948FA8324"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>更新了说明DIL为何使用 <code> GET</code> 和 <code> POST</code> 用于在事件调用中发送数据的方法。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_183F245818BC4CF5AAB9B610C1BE4A9F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>更新了 <span class="wintitle"> Audience Optimization</span>报表包含跨渠道转化、基于角色的访问控制、转化群组以及报告的转化特征报表。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>的 <span class="wintitle"> 跨渠道转化</span> 选项 <span class="wintitle"> Audience Optimization</span> 报表允许您将离线转化归因为提供的在线展示次数或点击次数。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E71252DF328F42A3AB0BD2CA7DC5A549"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>从 <span class="keyword"> Audience Manager</span> 文档介绍。 已移至 <span class="keyword"> Analytics</span> 文档。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../integration/media-data-integration/impression-data-pixels.md"> 通过像素调用捕获营销活动展示数据 </a> </p> </td> 
   <td colname="col2"> <p>更新了以包含通过 <code> d_cid</code>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_106BAD4680F1446B813A907F9E3ADCB8"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://experienceleague.adobe.com/docs/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html" format="https" scope="external"> Audience Manager区段</a> </p> </td> 
...
<table id="table_BF1B40564C3C4B569A3B2504ACEEE0E4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>描述操作方法 <span class="wintitle"> Audience Marketplace</span> 数据提供程序停用订阅者的馈送。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md"> 在提供程序停用我的数据馈送之后会发生什么情况 </a> </p> </td> 
   <td colname="col2"> <p>描述 <span class="wintitle"> Audience Marketplace</span> 如果提供商撤销对数据馈送的访问权限，数据购买者可能会期待。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../api/dcs-intro/dcs-api-reference/dcs-error-codes.md"> DCS 错误代码、消息和示例 </a> </p> </td> 
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>修订了 <code> declaredId</code>. 客户 ID 只能作为一个未编码的值进行传递。编码 ID 后将创建双重编码的标识符。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../integration/media-data-integration/impression-data-pixels.md"> 通过像素调用捕获营销活动展示数据 </a> </p> </td> 
   <td colname="col2"> <p>为 <code> d_mid</code> 和 <code> d_region</code>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>添加了对 <span class="wintitle"> 事件类型</span>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>列出并定义 <span class="wintitle"> Audience Marketplace</span> 账单报表。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/segments/segment-builder-data.md"> 区段生成器中的特征和区段大小数据 </a> </p> </td> 
   <td colname="col2"> <p>更新了描述特征和区段30天总计之间差异的文本。 </p> </td> 
  </tr> 
  <tr> 
