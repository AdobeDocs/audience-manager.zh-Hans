---
description: 当报表达到 100 万条记录上限时，您可以为重叠报表申请一个 .csv 文件。當您看到「發生非預期的錯誤」訊息時，報表可能已達到此限制。 請聯絡客戶服務以要求壓縮.csv檔案，以便您匯入並在您自己的資料庫系統中使用。 檔案適用於區段對區段、區段對特徵和特徵對特徵重疊報表。
...
当报表达到 100 万条记录上限时，您可以为重叠报表申请一个 .csv 文件。當您看到「發生非預期的錯誤」訊息時，報表可能已達到此限制。 請聯絡客戶服務以要求壓縮.csv檔案，以便您匯入並在您自己的資料庫系統中使用。 檔案適用於區段對區段、區段對特徵和特徵對特徵重疊報表。

## 檔案名稱中繼資料 {#file-name-metadata}

下表列出並說明重疊.csv檔案中使用的檔案命名慣例和副檔名。 在示例中，*斜体*&#x200B;表示变量占位符。
...
<table id="table_C99FCABA365B4AB99620F27D4414E623"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>文件 副檔名 </p> </td> 
   <td colname="col2"> <p>重疊報表檔案會以gzip壓縮，並有 <code> .gz</code> 副檔名。 您必須新增 <code> .csv</code> 解壓縮後檔案的副檔名。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>報表的日期範圍是5位數的識別碼，其中包括： </p> <p> 
     <ul id="ul_7B334CDFD7DA42AC8F383BE0F8F77FB9"> 
      <li id="li_0045DED532E747C08824DCC98A9174B3"> <code> 70000</code> （7天報表）。 </li> 
      <li id="li_3A22775F78E648BF8AC32A9E1AF1F5DE"> <code> 30000</code> （30天報表）。 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>多個檔案 </p> </td> 
   <td colname="col2"> <p>如果報告包含多個檔案，我們會遞增檔案名稱的最後一位數字。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>示例 </p> </td> 
   <td colname="col2"> <p>單一報表的檔案名稱範例： </p> <p> 
     <ul id="ul_EED13F73F37D48868236F8945E19C88F"> 
      <li id="li_55DD677F9BA7460AA4AAD27AFD08A5AE">單一，7天檔案： <code> S2S_overlap_12345_2017_01_14_70000.gz</code> </li> 
      <li id="li_487F8B76B7F24DCEB890C2D8186728F7">30天單一檔案： <code> S2S_overlap_12345_2017_01_14_30000.gz</code> </li> 
...
您的的資料檔案 [區段對區段重疊報表](segment-segment-overlap-report.md) 包含下列記錄。
...
<table id="table_1BDC7019DF2543069D7AE229C5E2454E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>您要與基線區段進行比較的區段名稱。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> segment_id2</code> </p> </td> 
   <td colname="col2"> <p>基準線區段的ID。 基準線區段是您要與其他區段進行比較的區段。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>您可以取得7天和30天回顧間隔的報表。 此 <code> rangeid</code> 與下面顯示的時間間隔相對應。 </p> <p> 
...
您的的資料檔案 [區段對特徵重疊報表](segment-trait-overlap-report.md) 包含下列記錄。
...
<table id="table_45270B5D01014AD99921B320D3A32DB6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>特徵中的不重複使用者人數。 在UI報表中，當您將滑鼠游標停留在熱度圖結果中的特徵上時，此數字會顯示在快顯視窗中。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> overlap_uniques</code> </p> </td> 
   <td colname="col2"> <p>所選區段和特徵之間共用的不重複使用者數。 在UI報表中，當您將滑鼠游標停留在熱度圖結果中的特徵上時，此數字會顯示在快顯視窗中。 </p> </td> 
  </tr> 
  <tr> 
...
您的的資料檔案 [特徵對特徵重疊報表](trait-trait-overlap-report.md) 包含下列記錄。
...
<table id="table_603216E6AFE4439A87C91DDFF2989F53"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>基線特徵的ID。 基線特徵是您想要與其他特徵進行比較的特徵。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> base_trait_name</code> </p> </td> 
   <td colname="col2"> <p>您要與其他特徵進行比較的基線特徵名稱。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> dataprovider_type</code> </p> </td> 
   <td colname="col2"> <p>資料提供者ID。 ID包括： </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>基本特徵中的不重複使用者人數。 在UI報表中，當您將滑鼠游標停留在熱度圖結果中的特徵上時，此數字會顯示在快顯視窗中。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> overlap_uniques</code> </p> </td> 
   <td colname="col2"> <p>在所選特徵之間共用的不重複使用者數。 在UI報表中，當您將滑鼠游標停留在熱度圖結果中的特徵上時，此數字會顯示在快顯視窗中。 </p> </td> 
