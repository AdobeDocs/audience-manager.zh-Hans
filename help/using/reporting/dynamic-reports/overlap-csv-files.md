...
<table id="table_C99FCABA365B4AB99620F27D4414E623"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>重叠的报告文件经过gzip压缩，并具有 <code> .gz</code> 文件扩展名。 解压缩后，必 <code> .csv</code> 须将扩展名添加到文件。 </p> </td> 
  </tr> 
  <tr> 
...
## 细分到细分报表记录 {#segment-segment-records}

“段到段重叠 [报表”的数据文件](segment-segment-overlap-report.md) ，包含以下记录。
...
<table id="table_1BDC7019DF2543069D7AE229C5E2454E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>您可以获得7天和30天回顾间隔的报告。 与 <code> rangeid</code> 下面显示的时间间隔相对应。 </p> <p> 
...
区段到特征重 [叠报表的数据文件包含](segment-trait-overlap-report.md) 以下记录。
...
特征到特征重 [叠报表的数据文件包含](trait-trait-overlap-report.md) 以下记录。
