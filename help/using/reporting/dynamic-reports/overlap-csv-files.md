---
description: 当报表达到 100 万条记录上限时，您可以为重叠报表申请一个 .csv 文件。当您看到“发生意外错误”消息时，报告可能已达到此限制。 请联系客户关怀部门以请求压缩的.csv文件，您可以在自己的数据库系统中导入和使用该文件。 文件可用于区段到区段、区段到特征和特征到特征重叠报表。
seo-description: 当报表达到 100 万条记录上限时，您可以为重叠报表申请一个 .csv 文件。当您看到“发生意外错误”消息时，报告可能已达到此限制。 请联系客户关怀部门以请求压缩的.csv文件，您可以在自己的数据库系统中导入和使用该文件。 文件可用于区段到区段、区段到特征和特征到特征重叠报表。
...
当报表达到 100 万条记录上限时，您可以为重叠报表申请一个 .csv 文件。当您看到“发生意外错误”消息时，报告可能已达到此限制。 请联系客户关怀部门以请求压缩的.csv文件，您可以在自己的数据库系统中导入和使用该文件。 文件可用于区段到区段、区段到特征和特征到特征重叠报表。

## 文件名元数据{#file-name-metadata}

下表列表介绍了重叠.csv文件中使用的文件命名约定和文件扩展名。 在示例中，*斜体*&#x200B;表示变量占位符。
...
<table id="table_C99FCABA365B4AB99620F27D4414E623"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>重叠报告文件经过压缩，文件扩展名为<code> .gz</code>。 解压缩后，必须将<code> .csv</code>扩展名添加到文件。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>报表的日期范围是一个5位ID，包括： </p> <p> 
...
在文件中，字符串数据用多次引号括起来。 请参阅下面的模型数据。 为了简洁和适合屏幕大小，已截断。
...
## 区段对区段报表记录{#segment-segment-records}
...
<table id="table_1BDC7019DF2543069D7AE229C5E2454E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>要与基线区段比较的区段中的独特用户数。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>基线区段与选择进行比较的其他区段之间唯一用户重叠的总计数。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_45270B5D01014AD99921B320D3A32DB6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>特征中的唯一用户数。 在UI报表中，如果将鼠标悬停在热图结果中的某个特征上，此数字将显示在弹出窗口中。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> overlap_uniques</code> </p> </td> 
   <td colname="col2"> <p>在选定区段和特征之间共享的唯一用户数。 在UI报表中，如果将鼠标悬停在热图结果中的某个特征上，此数字将显示在弹出窗口中。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> trait_uniques_overlap_perc</code> </p> </td> 
   <td colname="col2"> <p>特征和区段之间重叠的唯一用户百分比。 在UI报表中，如果将鼠标悬停在热图结果中的某个特征上，此数字将显示在弹出窗口中。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> segment_uniques_overlap_perc</code> </p> </td> 
   <td colname="col2"> <p>区段和特征之间重叠的唯一用户百分比。 在UI报表中，如果将鼠标悬停在热图结果中的某个特征上，此数字将显示在弹出窗口中。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_603216E6AFE4439A87C91DDFF2989F53"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>要与基线特征比较的特征的ID。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> overlap_trait_name</code> </p> </td> 
   <td colname="col2"> <p>要与基线特征比较的特征的名称。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在所选特征之间共享的唯一用户数。 在UI报表中，如果将鼠标悬停在热图结果中的某个特征上，此数字将显示在弹出窗口中。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> base_trait_uniques</code> </p> </td> 
   <td colname="col2"> <p>基本特征中的唯一用户数。 在UI报表中，如果将鼠标悬停在热图结果中的某个特征上，此数字将显示在弹出窗口中。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> overlap_uniques</code> </p> </td> 
   <td colname="col2"> <p>在所选特征之间共享的唯一用户数。 在UI报表中，如果将鼠标悬停在热图结果中的某个特征上，此数字将显示在弹出窗口中。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在所选特征之间重叠的唯一用户百分比。 在UI报表中，如果将鼠标悬停在热图结果中的某个特征上，此数字将显示在弹出窗口中。 </p> </td> 
  </tr> 
  <tr> 
