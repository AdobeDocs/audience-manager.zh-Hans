...
seo-description: 描述Adobe Audience Manager中相同特征和时间段报表之间唯一用户总数的变化情况
seo-title: 在AAM中对重叠和一般报告中的唯一用户计数
...
* 在报告的选定时间间隔内。
* 它的 [生存时间值比报](../features/traits/segment-ttl-explained.md) 表的选定时间间隔长。
